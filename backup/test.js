! function(e) {
  ...
  var ye, ve, be, ge, Ee, we, Se, ke, Oe = function(e) {
      function t(e) {
        r(this, t);
    ...
    Ue = function(e) {
      return /^pk_test_/.test(e) ? Be.test : /^pk_live_/.test(e) ? Be.live : Be.unknown
    },
    He = function(e) {
      if (e === Be.unknown) throw new Pe("It looks like you're using an older Stripe key. In order to use this API, you'll need to use a modern API key, which is prefixed with 'pk_live_' or 'pk_test_'.\n    You can roll your publishable key here: https://dashboard.stripe.com/account/apikeys")
    },
    ...
    $e = function(e, t) {
      return function(n, r) {
        var o = function(e) {
          ...
          i = function(e, t, n) {
            return Ke(new Pe("Invalid value for " + e + ": " + t + ". You specified " + n + "."))
          },
          a = e(n, r),
          c = t(n, r);
        if ("error" === a.type && "error" === c.type) {
          if ("mismatch" === a.errorType && "mismatch" === c.errorType) {
            var u = o(a),
              ...
              d = p.error,
              f = p.actual;
            return i(r.label, s === d ? s : s + " or " + d, l === f ? l : l + " and " + f)
          }
    ...
    nt = et.apply(void 0, c(Fe)),
    rt = et.apply(void 0, c(qe)),
    ot = (et.apply(void 0, c(Object.keys(Be))), function(e, t) {
            ...
            if ("valid" === o.type)
              for (var i = {}, a = 0; a < o.value.length; a += 1) {
                ...
                if ("object" === (void 0 === c ? "undefined" : Ye(c)) && c && "string" == typeof c[e]) {
                  var u = c[e];
                  if (i[u]) return Ke(new Pe("Duplicate value for " + e + ": " + u + ". The property '" + e + "' of '" + r.path.join(".") + "' has to be unique."));
                  i[u] = !0
                }
              }
            return o
      ...
      return function(t) {
        return function(n, r) {
          if (n && "object" === (void 0 === n ? "undefined" : Ye(n)) && !Array.isArray(n)) {
            ...
            if (i && e) return Ke(new Pe("Invalid " + r.label + " parameter: " + [].concat(c(r.path), [i]).join(".") + " is not an accepted parameter."));
            var u = Object.keys(o),
              s = We({});
            return i && (s = u.reduce(function(e, n) {
              ...
              return "valid" === u.type && void 0 !== u.value ? We(ze({}, e.value, a({}, n, u.value)), [].concat(c(e.warnings), c(u.warnings))) : "valid" === u.type ? We(e.value, [].concat(c(e.warnings), c(u.warnings))) : u
            }, s)
          }
    ...
    gt = function(e, t, n, r) {
      ...
      return "valid" === i.type ? i : "full" === i.errorType ? i : {
        type: "error",
        errorType: "full",
        error: new Pe(Ge(i.expected, i.actual, i.options))
      }
    },
    Et = function(e, t, n, r) {
      var o = gt(e, t, n, r);
    ...
    Tt = Object({
      ...
      THREE_DS_2_FINGERPRINT_HTML_NAME: "three-ds-2-fingerprint-e4c13f55b67cf930ce5d9f06f9714dbe.html",
      THREE_DS_2_CHALLENGE_HTML_NAME: "three-ds-2-challenge-d979a71ef8227f1066f4c244625434d3.html",
      AUTHORIZE_WITH_URL_INNER_HTML_NAME: "authorize-with-url-inner-6bf02eb956fa7e4d4f3199969de85c94.html",
      PAYMENT_REQUEST_INNER_GOOGLE_PAY_HTML_NAME: "payment-request-inner-google-pay-7649cc6af1f77e7a5a1b3f734918082e.html",
      PAYMENT_REQUEST_INNER_BROWSER_HTML_NAME: "payment-request-inner-browser-295e2edd9003952336161a71aa746cae.html",
      CONTROLLER_HTML_NAME: "controller-aa9903ff186968008fb3408d381a22d4.html",
      RECAPTCHA_HTML_NAME: "recaptcha.html",
      ELEMENTS_INNER_FPX_BANK_HTML_NAME: "elements-inner-fpx-bank.html",
      ELEMENTS_INNER_AU_BANK_ACCOUNT_HTML_NAME: "elements-inner-au-bank-account-c8e581ac5f3ef70f2f603b49ecac9ef8.html",
      ELEMENTS_INNER_PAYMENT_REQUEST_HTML_NAME: "elements-inner-payment-request-b72a77faeded6df7ea57e4b3461ba3f7.html",
      ELEMENTS_INNER_IDEAL_BANK_HTML_NAME: "elements-inner-ideal-bank-085a6e0ae44e469ccbfcd35c161960f5.html",
      ELEMENTS_INNER_IBAN_HTML_NAME: "elements-inner-iban-f7e5ae47263850dd90ba6af2dedc4bd2.html",
      ELEMENTS_INNER_CARD_HTML_NAME: "elements-inner-card-0e6b1c213582529bad1915fa49612d30.html",
    ...
    tn = function(e) {
      if (!document.body) throw new Pe("Stripe.js requires that your page has a <body> element.");
    ...
    dn = function e() {
      var t = this;
      s(this, e), this._emit = function(e) {
        ...
        if ("string" != typeof e) throw new Pe("When adding an event listener, the first argument should be a string event name.");
        if ("function" != typeof n) throw new Pe("When adding an event listener, the second argument should be a function callback.");
      ...
      var n = sn(this._userOn),
        r = sn(this._off),
        o = sn(this._once),
        i = un(this._hasRegisteredListener),
        a = un(this._removeAllListeners),
        c = pn(this._emit);
    ...
    mn = function(e) {
      ...
      return f(t, e), _n(t, [{
        ...
        value: function(e) {
          ...
          return i.setAttribute("frameborder", "0"), i.setAttribute("allowTransparency", "true"), i.setAttribute("scrolling", "no"), i.setAttribute("name", this.id), i.setAttribute("allowpaymentrequest", "true"), i.src = Nt(this.type) + "#" + o, i
        }
      }]), t
    }(fn),
    yn = mn,
    ...
    En = function(e) {
      ...
      return m(t, e), vn(t, [{
        ...
        value: function() {
          ...
          else if ("complete" === document.readyState || "interactive" === document.readyState) throw new Pe("Stripe.js requires that your page has a <body> element.");
        ...
        value: function(e) {
          ...
          return n.setAttribute("aria-hidden", "true"), n.setAttribute("allowpaymentrequest", "true"), n.setAttribute("tabIndex", "-1"), Xt(n, gn), n
        }
      }]), t
    }(yn),
    wn = En,
    ...
    In = function(e) {
      ...
      return w(t, e), Pn(t, [{
        ...
        value: function(e) {
          ...
          return n.setAttribute("title", "Secure payment input frame"), Xt(n, Tn), n
        }
      }]), t
    }(yn),
    Rn = In,
    ...
    Mn = function() {
      return tn(function(e) {
        var t = e.style,
          ...
          a = t.right,
          c = t.overflow,
          u = document.documentElement ? document.documentElement.style : {
            overflow: ""
          },
          s = u.overflow,
          l = window,
        ...
        return e.style.position = "fixed", e.style.overflow = "hidden", document.documentElement && (document.documentElement.style.overflow = "visible"), e.style.top = -d + "px", e.style.left = -p + "px", e.style.right = f + "px", e.style.bottom = h + "px", Cn(function() {
          e.style.position = n, e.style.top = r, e.style.left = o, e.style.bottom = i, e.style.right = a, e.style.overflow = c, document.documentElement && (document.documentElement.style.overflow = s), window.scrollTo(p, d)
        })
      })
    },
    jn = function(e, t) {
    ...
    Un = function e(t) {
      ...
      S(this, e), this.domElement = document.createElement("div"), this._runOnHide = [], this.mount = function() {
        ...
        if (Xt(n.domElement, Fn), n._lockScrolling) {
          var e = Mn();
          n._runOnHide.push(e)
        }
        if (n._lockFocus) {
        ...
        return new Ne(function(e) {
          Xt(n.domElement, Fn), setTimeout(e, 500), n.domElement.addEventListener("transitionend", e)
        }).then(function() {
    ...
    Gn = function(e) {
      function t(e, n, r) {
        ...
        return o._autoMount = function() {
          ...
          o._backdrop.show(), Xt(o._iframe, Yn)
    ...
    $n = function(e) {
      ...
      return I(t, e), Vn(t, [{
        ...
        value: function(e) {
          ...
          return Xt(n, Qn), n.style.height = "0", n
        }
      }]), t
    }(yn),
    Zn = $n,
    ...
    _r = (function(e) {
      ...
      return /^((?!chrome|android).)*safari/i.test(e) && !ur(e)
    }(pr)),
    mr = (function(e) {
      /Firefox\//i.test(e)
    }(pr), function(e) {
    ...
    Pr = (be = {}, C(be, Mt.card, Sr), C(be, Mt.cardNumber, Sr), C(be, Mt.iban, kr), C(be, Mt.auBankAccount, Or), be),
    ...
    Cr = function(e) {
      return "object" === (void 0 === e ? "undefined" : Ir(e)) && null !== e && "IntegrationError" === e.name ? new Pe("string" == typeof e.message ? e.message : "") : e
    },
    Mr = function e(t) {
      ...
      var n = t.apiKey,
        ...
        o = t.stripeJsId,
        i = t.locale;
      this._id = Yt("__privateStripeController"), this._stripeJsId = o, this._apiKey = n, this._stripeAccount = r, this._controllerFrame = new On(At.CONTROLLER, this._id, Tr({}, t)), this._frames = {}, this._requests = {}, this._setupPostMessage(), this._handleMessage = un(this._handleMessage, this), this.action.fetchLocale({
        locale: i || "auto"
      })
    },
    jr = function() {
      ...
      this._sendCAReq = function(t) {
        ...
        if (n === e._id) switch (o.action) {
          case "stripe-frame-event":
            ...
            if (i) {
              if (hr) {
                var s = i._iframe.parentElement,
                  l = s && s.querySelector(".__PrivateStripeElement-input");
                ...
                "blur" === c && setTimeout(function() {
                  ...
                  if (e && !Nr(i, l) && !ir(e)) {
                    var t = s && s.querySelector(".__PrivateStripeElement-safariInput");
                    if (t) {
                      var n = t;
    ...
    Gr = function e(t) {
      return function() {
        for (var n = arguments.length, r = Array(n), o = 0; o < n; o++) r[o] = arguments[o];
        if (Array.isArray(r[0]) && t) return Yr(r[0]);
    ...
    Zr = function e(t) {
      return new Ne(function(n, r) {
        ...
        c && (p.withCredentials = c), p.open(o, s, !0), $r(p), p.onreadystatechange = function() {
    ...
    ro = function(e, t) {
      var n = e.replace(/\/\*.*\*\//g, "").trim(),
        ...
        o = r.match(/((([^;(]*\([^()]*\)[^;)]*)|[^;]+)+)(?=;)/g);
      if (!o) throw new Pe("Found @font-face rule containing no valid font-properties in file from " + t);
      return o
    },
    oo = function(e, t) {
      var n = e.indexOf(":");
      if (-1 === n) throw new Pe("Invalid css declaration in file from " + t + ': "' + e + '"');
      var r = e.slice(0, n).trim(),
        o = Ut[r];
      if (!o) throw new Pe("Unsupported css property in file from " + t + ': "' + r + '"');
      return {
        property: o,
    ...
    io = function(e, t) {
      ...
      return ["family", "src"].forEach(function(e) {
        if (!n[e]) throw new Pe("Missing css property in file from " + t + ': "' + Bt[e] + '"')
      }), n
    },
    ao = function(e) {
      return Xr({
    ...
    go = et.apply(void 0, F(Object.keys(ho))),
    Eo = vt({
      origin: ot,
      name: ot
    }),
    ...
    ko = function(e, t) {
      ...
      return et.apply(void 0, F(Object.keys(po)))(-1 !== n.indexOf(e) ? "fail" : e, t)
    },
    Oo = vt({
      displayItems: Qe(ft(vo)),
      shippingOptions: Qe(ht("id")(ft(bo))),
    ...
    Po = et.apply(void 0, F(Object.keys(_o))),
    Ao = function(e) {
      var t = Br(e, Dr.google_pay_beta_1);
    ...
    Mo = function(e, t, n, r) {
      ...
      if (window.ApplePaySession) {
        if (Io()) {
          ...
          return n && window.console && window.console.warn("This version of Safari does not support ApplePay JS version " + i + "."), Ne.resolve(!1)
        }
        return Ne.resolve(!1)
      }
      return Ne.resolve(!1)
    ...
    xo = function(e, t) {
      ...
      return -1 !== Lo.indexOf(e) ? ["amex"].concat(B(n)) : n
    },
    qo = function(e, t) {
    ...
    Wo = (Ee = {}, U(Ee, _o.success, 0), U(Ee, _o.fail, 1), U(Ee, _o.invalid_payer_name, 2), U(Ee, _o.invalid_shipping_address, 3), U(Ee, _o.invalid_payer_phone, 4), U(Ee, _o.invalid_payer_email, 4), Ee),
    ...
    Qo = {
      ...
      supportedNetworks: function(e) {
        return qo(e.country, e.jcbEnabled || !1)
      }
    },
    $o = {
      status: function(e) {
    ...
    ei = function(e) {
      var t = Uo({}, mo, e);
      return Object.keys(Zo).reduce(function(e, n) {
        var r = Zo[n],
          o = r(t);
    ...
    ti = function(e) {
      return Object.keys(Xo).reduce(function(t, n) {
        var r = Xo[n],
          o = r(e);
    ...
    _i = function() {
      function e(t) {
        ...
        z(this, e), this._onEvent = function() {}, this.setEventHandler = function(e) {
          ...
          return Mo(window.location.hostname, n._authentication.accountId, Ue(n._authentication.apiKey) === Be.test, n._report, n._minimumVersion)
        }, this.update = function(e) {
          n._initialPaymentRequest = Wr(n._paymentRequestOptions, e), n._initializeSessionState()
        }, this.show = function() {
          ...
          try {
            ...
            throw "Must create a new ApplePaySession from a user gesture handler." === e.message ? new Pe("show() must be called from a user gesture handler (such as a click handler, after the user clicks a button).") : e
          }
          ...
          return function(t) {
            n._paymentRequestOptions = Wr(n._paymentRequestOptions, t), n._paymentRequestOptions.shippingOptions && n._paymentRequestOptions.shippingOptions.length && (n._privateShippingOption = n._paymentRequestOptions.shippingOptions[0]);
            var r = ti(n._paymentRequestOptions),
              o = r.status,
              i = r.shippingMethods,
              a = r.total,
        ...
        this._controller = r, this._authentication = o, this._mids = i, this._minimumVersion = a.__minApplePayVersion || Ro, this._usesButtonElement = c, this._initialPaymentRequest = a, this._isShowing = !1, this._initializeSessionState()
      }
      return pi(e, [{
        ...
        value: function(e, t) {
          var n = this;
          e.addEventListener("validatemerchant", un(this._validateMerchant(e, t))), e.addEventListener("paymentauthorized", un(this._paymentAuthorized(e))), e.addEventListener("cancel", un(function() {
            n._isShowing = !1, n._onEvent({
              type: "cancel"
            }), n._onEvent({
              type: "close"
            })
          })), e.addEventListener("shippingcontactselected", un(this._shippingContactSelected(e))), e.addEventListener("shippingmethodselected", un(this._shippingMethodSelected(e)))
        }
      }]), e
    }(),
    mi = _i,
    ...
    Si = function e(t) {
      var n = this;
      Y(this, e), this._mids = null, this._frame = null, this._backdrop = new Hn({
        lockScrolling: !1,
        lockFocus: !0,
        lockFocusOn: null
      ...
      }, this._controller = t.controller, this._authentication = t.authentication, this._mids = t.mids, this._usesButtonElement = t.usesButtonElement, Ei() && this._controller && (this._controller.action.fetchLocale({
        locale: "auto"
    ...
    Pi = null,
    Ai = function(e, t) {
      return null !== Pi ? Ne.resolve(Pi) : Oi ? t && "https:" !== window.location.protocol ? (window.console && window.console.warn("To test Payment Request, you must serve this page over HTTPS."), Ne.resolve(!1)) : e ? e.action.checkCanMakePayment().then(function(e) {
        var t = e.available;
        return Pi = !0 === t
    ...
    Ii = function e(t) {
      G(this, e), Ri.call(this);
      var n = t.authentication,
        r = t.controller,
        o = t.mids,
        i = t.usesButtonElement,
        a = t.options;
      if (this._authentication = n, this._controller = r, this._mids = o, this._usesButtonElement = i, Oi && "https:" === window.location.protocol) {
    ...
    Ri = function() {
      ...
      this._onEvent = function() {}, this.setEventHandler = function(t) {
        ...
        return Ai(e._prFrame, Ue(e._authentication.apiKey) === Be.test)
        ...
        if (!e._prFrame) throw new Pe("Payment Request is not available in this browser.");
        e._prFrame.send({
          action: "stripe-pr-show",
          payload: {
            data: {
    ...
    Mi = function(e) {
      function t(e) {
        ...
        ji.call(n), n._controller = e.controller, n._authentication = e.authentication, n._mids = e.mids, n._report("pr.options", {
        ...
        if (r.warnings.forEach(function(e) {
            return n._warn(e)
          }), o.__billingDetailsEmailOverride && o.requestPayerEmail) throw new Pe("When providing `__billingDetailsEmailOverride`, `requestPayerEmail` has to be `false` so that the customer is not prompted for their email in the payment sheet.");
    ...
    ji = function() {
      ...
      this._usedByButtonElement = null, this._showCalledByButtonElement = !1, this._isShowing = !1, this._backingLibraries = {
        ...
        e._queryStrategy.forEach(function(n) {
          ...
          switch (n) {
            case "APPLE_PAY":
              e._backingLibraries.APPLE_PAY = new mi(r), e._backingLibraries.APPLE_PAY.setEventHandler(e._handleInternalEvent);
              break;
            case "GOOGLE_PAY":
              e._backingLibraries.GOOGLE_PAY = new ki(r), e._backingLibraries.GOOGLE_PAY.setEventHandler(e._handleInternalEvent);
              break;
            case "BROWSER":
              e._backingLibraries.BROWSER = new Ni(r), e._backingLibraries.BROWSER.setEventHandler(e._handleInternalEvent);
              break;
            default:
              Ae(n)
          }
          ...
          case "shippingaddresschange":
            var n = t.type,
              ...
              c = function(c) {
                ...
                var u = Et(Oo, c || {}, n + " callback"),
                  s = u.value;
                u.warnings.forEach(function(t) {
                  return e._controller.warn(t)
                });
                var l = s.shippingOptions || e._initialOptions.shippingOptions;
                if (!("shippingaddresschange" !== t.type || s.status !== _o.success || l && l.length)) throw new Pe("When requesting shipping information, you must specify shippingOptions once a shipping address is selected.\nEither provide shippingOptions in stripe.paymentRequest(...) or listen for the shippingaddresschange event and provide shippingOptions to the updateWith callback there.");
                r.updateWith(s)
              };
          ...
          case "paymentmethod":
            var u = t.type,
              ...
              f = function(t) {
                ...
                var n = Et(Po, t, "status for PaymentRequest completion"),
                  r = n.value;
        ...
        var n = (t.__googlePayBillingAddress, K(t, ["__googlePayBillingAddress"])),
          r = n.token,
          o = K(n, ["token"]),
          i = o.payerEmail,
          a = o.payerPhone,
        ...
        e._hasRegisteredListener("token") && e._maybeEmitPaymentResponse({
          ...
          sourceData: {
            token: r.id,
            owner: {
              email: e._initialOptions.__billingDetailsEmailOverride || i,
              phone: a
            }
          },
          mids: null
        }).then(function(t) {
          "error" === t.type ? t.error.code && "email_invalid" === t.error.code ? c("invalid_payer_email") : (e._report("fatal.pr.token_to_source_failed", {
            error: t.error,
            token: r.id
          ...
          "error" === t.type ? t.error.code && "email_invalid" === t.error.code ? c("invalid_payer_email") : (e._report("fatal.pr.token_to_payment_method_failed", {
            error: t.error,
            token: r.id
          }), c("fail")) : e._maybeEmitPaymentResponse({
            type: "paymentmethod",
      ...
      }, this.canMakePayment = un(function() {
      ...
      }), this.update = un(function(t) {
        if (e._isShowing) throw e._report("pr.update_called_while_showing"), new Pe("You cannot update Payment Request options while the payment sheet is showing.");
        e._report("pr.update", {
          updates: t
        });
        ...
        if (!e._activeBackingLibrary) throw e._report("pr.show_called_with_can_make_payment_false"), new Pe("Payment Request is not available in this browser.");
        var t = e._activeBackingLibrary;
        e._report("pr.show", {
          listeners: Object.keys(e._callbacks).sort()
        }), e._isShowing = !0, t.show()
      }), this.abort = un(function() {
    ...
    Di = vt(qi),
    Fi = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
      return typeof e
    } : function(e) {
      return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
    },
    ...
    Hi = function(e, t) {
      var n = Bi(e),
        r = "auBankAccount" === n && !Br(t, "au_bank_account_beta_1") && !Br(t, "au_bank_account_beta_2") || "fpxBank" === n && !Br(t, "fpx_bank_beta_1");
      if (!n || r) throw new Pe("A valid Element name must be provided. Valid Elements are:\n" + Object.keys(gr).filter(function(e) {
        return !gr[e].beta
      }).join(", ") + "; you passed: " + (n || (void 0 === e ? "undefined" : Fi(e))) + ".")
    },
    zi = function(e, t, n) {
      if (Hi(e, n), gr[e].unique && -1 !== t.indexOf(e)) throw new Pe("Can only create one Element of type " + e + ".");
      var r = gr[e].conflict,
        o = je(t, r);
      if (o.length) {
        var i = o[0];
        throw new Pe("Cannot create an Element of type " + e + " after an Element of type " + i + " has already been created.")
      }
    },
    Yi = "14px",
    Gi = function(e) {
    ...
    Wi = function() {
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "1.2em",
        t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Yi,
    ...
    ta = function(e) {
      function t(e) {
        ...
        if (a) {
          if (!i) throw new Pe("You must pass in a stripe.paymentRequest object in order to use this Element.");
          n._paymentRequest = i, n._paymentRequest._registerElement()
        }
        return n._createComponent(e, o), n._classes = Qi, n._computeCustomClasses(e.classes || {}), n._lastBackgroundColor = "", n._destroyed = !1, n._focused = !1, n._empty = !a, n._invalid = !1, n._complete = !1, n._autofilled = !1, n._lastSubmittedAt = null, n
      }
      return te(t, e), Ji(t, [{
        key: "_checkDestroyed",
        value: function() {
          if (this._destroyed) throw new Pe("This Element has already been destroyed. Please create a new one.")
        }
      }, {
        key: "_isMounted",
        value: function() {
        ...
        value: function(e) {
          ...
          if (e === t) {
            ...
            if (n) throw new Pe("This Element is already mounted. Use `unmount()` to unmount the Element before re-mounting.");
            this.unmount(), this._mountTo(e)
        ...
        value: function(e) {
          ...
          return Object.keys(e).forEach(function(n) {
            if (!Qi[n]) throw new Pe(n + " is not a customizable class name.\nYou can customize: " + Object.keys(Qi).join(", "));
            var r = e[n] || Qi[n];
            t[n] = r.replace(/\./g, " ")
          }), this._classes = Vi({}, this._classes, t), this
        }
      }, {
        key: "_emitEvent",
        value: function(e, t) {
          return this._emit(e, Vi({
        ...
        value: function() {
          ...
          this._frame._on("redirectfocus", function(t) {
            ...
            var n = {};
            ["error", "value", "empty", "complete"].concat(Z(Pr[e._componentName] || [])).forEach(function(e) {
              return n[e] = t[e]
            ...
            if (e._parent) {
              ...
              if (n) {
                ...
                0 !== r && Xi(r) < Xi(o) && e._controller.report("wrapper_height_mismatch", {
                  height: o,
                  outer_height: r
                });
        ...
        value: function(e, t, n) {
          var r = this._controller.createSecondaryElementFrame(e, Vi({}, n, {
            componentName: t
          }));
        ...
        value: function(e) {
          ...
          if ("paymentRequestButton" === this._componentName) {
            ...
            var i = e.style && e.style.base || {},
              ...
              c = i.fontSize,
              u = i.padding,
              s = "string" != typeof a || isNaN(parseFloat(a)) ? void 0 : a,
              l = "string" == typeof c ? c : void 0,
              p = "string" == typeof u ? u : void 0;
            if (l && !ea(l) && this._controller.warn("The fontSize style you specified (" + l + ") is not in px. We do not recommend using relative css units, as they will be calculated relative to our iframe's styles rather than your site's."), t || s || l) {
              var d = -1 === Ht.indexOf(this._componentName) ? void 0 : p || this._lastPadding,
                f = Ki(s || this._lastHeight, l || this._lastFontSize, d);
              this._frame.updateStyle({
                height: f
              }), this._lastFontSize = l || this._lastFontSize, this._lastHeight = s || this._lastHeight, this._lastPadding = d
            }
          }
        }
      }, {
        ...
        value: function(e, t) {
          ...
          i.className = "__PrivateStripeElement-input", i.setAttribute("aria-hidden", "true"), i.setAttribute("aria-label", " "), i.setAttribute("autocomplete", "false"), i.maxLength = 1, i.disabled = !0, Xt(o, $i), Xt(i, Zi);
          var a = Ln(document.body),
            ...
            l = this._controller.createElementFrame(u, s);
          if (l._on("load", function() {
            ...
            this._secondaryFrame = this._createSecondFrame(u, p, Vi({}, s, {
              primaryElementType: t
            })), this._secondaryFrame.appendTo(o), window.addEventListener("click", function() {
              return n._handleOutsideClick()
            })
          }
          if (o.appendChild(i), hr && t !== Mt.paymentRequestButton) {
            var d = document.createElement("input");
            d.className = "__PrivateStripeElement-safariInput", d.setAttribute("aria-hidden", "true"), d.setAttribute("tabindex", "-1"), d.setAttribute("autocomplete", "false"), d.maxLength = 1, d.disabled = !0, Xt(d, Zi), o.appendChild(d)
          }
    ...
    na = function() {
      var e = this;
      this._paymentRequest = null, this.mount = un(function(t) {
        e._checkDestroyed();
        var n = void 0;
        if (!t) throw new Pe("Missing argument. Make sure to call mount() with a valid DOM element or selector.");
        if ("string" == typeof t) {
          ...
          if (!t.appendChild) throw new Pe("Invalid DOM element. Make sure to call mount() with a valid DOM element or selector.");
          n = t
        }
        if ("INPUT" === n.nodeName) throw new Pe("Stripe Elements must be mounted in a DOM element that\ncan contain child nodes. `input` elements are not permitted to have child\nnodes. Try using a `div` element instead.");
        if (n.children.length && e._controller.warn("This Element will be mounted to a DOM element that contains child nodes."), e._paymentRequest) {
          if (!e._paymentRequest._canMakePaymentResolved) throw new Pe("For the paymentRequestButton Element, you must first check availability using paymentRequest.canMakePayment() before mounting the Element.");
          if (!e._paymentRequest._activeBackingLibraryName) throw new Pe("The paymentRequestButton Element is not available in the current environment.");
          e._mountToParent(n)
    ...
    ia = {
      locale: Qe(ot),
      fonts: Qe(ft(dt)),
      betas: Qe(ft(tt.apply(void 0, oe(Fr))))
    },
    aa = vt(ia),
    ca = function e(t, n) {
      var r = this;
      re(this, e), ua.call(this);
      var o = Et(aa, n || {}, "elements()"),
        i = o.value;
      ...
      this._pendingFonts = s.length;
      var l = (i.betas, ne(i, ["betas"]));
      return this._commonOptions = oa({}, l, {
        fonts: u
        ...
        if ("string" == typeof e) {
          ...
          co(e).then(function(n) {
            ...
            r._controller.action.updateCSSFonts({
              fonts: o,
              groupId: r._id
            }), r._commonOptions = oa({}, r._commonOptions, {
    ...
    ua = function() {
      var e = this;
      this.getElement = un(function(t) {
        var n = Ui(t) || t;
        return Hi(n, e._betas), Ce(e._elements, function(e) {
          return e._componentName === n
        }) || null
      }), this.create = sn(function(t, n) {
        zi(t, e._elements.map(function(e) {
        ...
        return e._elements = [].concat(oe(e._elements), [u]), u._on("destroy", function() {
    ...
    ma = (ke = {}, ie(ke, Mt.auBankAccount, _a.au_becs_debit), ie(ke, Mt.card, _a.card), ie(ke, Mt.cardNumber, _a.card), ie(ke, Mt.cardExpiry, _a.card), ie(ke, Mt.cardCvc, _a.card), ie(ke, Mt.postalCode, _a.card), ie(ke, Mt.iban, _a.sepa_debit), ie(ke, Mt.idealBank, _a.ideal), ie(ke, Mt.fpxBank, _a.fpx), ke),
    ya = function(e) {
    ...
    Ta = function(e, t) {
      ...
      if ("object" !== (void 0 === e ? "undefined" : Pa(e))) return Ve("object", void 0 === e ? "undefined" : Pa(e), t);
      var n = e.client_secret,
        r = e.status,
        o = e.next_action,
        i = Aa(n, bt(t, "client_secret"));
      if ("error" === i.type) return i;
      if ("string" != typeof r) return Ve("string", void 0 === r ? "undefined" : Pa(r), bt(t, "status"));
      if (("requires_source_action" === r || "requires_action" === r) && "object" !== (void 0 === o ? "undefined" : Pa(o))) return Ve("object", void 0 === o ? "undefined" : Pa(o), bt(t, "next_action"));
    ...
    Ia = function(e) {
      return function(t, n) {
        if ("object" !== (void 0 === t ? "undefined" : Pa(t))) return Ve("object", void 0 === t ? "undefined" : Pa(t), n);
        if (null === t) return Ve("object", "null", n);
        var r = t.type,
          o = ce(t, ["type"]),
          i = void 0;
        if (null === e) {
          if ("string" != typeof r) return Ve("string", void 0 === r ? "undefined" : Pa(r), bt(n, "type"));
          i = r
        } else {
          if (void 0 !== r && r !== e) return "string" != typeof r ? Ve("string", void 0 === r ? "undefined" : Pa(r), bt(n, "type")) : Ve('"' + r + '"', '"' + e + '"', bt(n, "type"));
          i = e
        }
        var a = t[i],
          c = ce(t, [i]);
        if ("object" !== (void 0 === a ? "undefined" : Pa(a))) return Ve("object or element", Pa(t[i]), bt(n, i));
        if (null === a) return Ve("object or element", "null", bt(n, i));
        var u = ha(a);
        if (u) {
          var s = u._componentName;
          if (ma[s] !== i) {
            var l = [].concat(ae(n.path), [i]).join("."),
              p = n.label,
              d = new Pe("Invalid value for " + p + ": " + l + " was `" + s + "` Element, which cannot be used to create " + i + " PaymentMethods.");
            return Ke(d)
          }
          return We({
            type: i,
    ...
    Na = function(e, t) {
      return function(n, r) {
        if (void 0 === n) return We({
          paymentMethodData: null,
          source: null,
          paymentMethod: null,
          otherParams: {}
        });
        if ("object" !== (void 0 === n ? "undefined" : Pa(n))) return Ve("object", void 0 === n ? "undefined" : Pa(n), r);
        if (null === n) return Ve("object", "null", r);
        var o = n.source,
          i = n.source_data,
          a = n.payment_method_data,
          c = n.payment_method,
          u = ce(n, ["source", "source_data", "payment_method_data", "payment_method"]);
        if (null != i) throw new Pe(t + ": Expected payment_method, or source, not source_data.");
        if (null != a) throw new Pe(t + ": Expected payment_method, or source, not payment_method_data.");
        if (null != o && null != c) throw new Pe(t + ": Expected either payment_method or source, but not both.");
        if (null != o) return "string" != typeof o ? Ve("string", void 0 === o ? "undefined" : Pa(o), bt(r, "source")) : We({
          source: o,
          paymentMethodData: null,
          paymentMethod: null,
          otherParams: u
        });
        if (null != c && "string" != typeof c && "object" !== (void 0 === c ? "undefined" : Pa(c))) return Ve("string or object", void 0 === c ? "undefined" : Pa(c), bt(r, "payment_method"));
        if ("string" == typeof c) return We({
          source: null,
          paymentMethodData: null,
          paymentMethod: c,
          otherParams: u
        });
        if ("object" === (void 0 === c ? "undefined" : Pa(c)) && null !== c) {
          var s = gt(Ia(e), c, t, {
    ...
    Ca = function(e) {
      ...
      var u = o || "/",
        s = (n || "").replace(/[^!#-+\--:<-[\]-~]/g, encodeURIComponent),
        l = encodeURIComponent(t) + "=" + s + ";expires=" + a.toGMTString() + ";path=" + u;
    ...
    La = "__privateStripeMetricsController",
    xa = {
      MERCHANT: "merchant",
      SESSION: "session"
    },
    qa = function() {
      function e() {
        ...
        if (ue(this, e), n.checkoutIds) {
          var r = n.checkoutIds,
            o = r.muid,
            i = r.sid;
          this._muid = o, this._sid = i, this._doNotPersist = !0
        } else this._muid = this._getID(xa.MERCHANT), this._sid = this._getID(xa.SESSION), this._doNotPersist = !1;
        this._id = Yt(La), this._controllerFrame = new On(At.METRICS_CONTROLLER, this._id, {
          autoload: !0,
        ...
        value: function() {
          ...
          setInterval(function() {
            ...
            n !== t && (e.send({
              action: "ping",
              payload: {
                sid: e._getID(xa.SESSION),
                muid: e._getID(xa.MERCHANT),
        ...
        value: function(e, t) {
          try {
            this.send({
              action: "track",
              payload: {
                sid: this._getID(xa.SESSION),
                muid: this._getID(xa.MERCHANT),
                url: document.location.href,
                source: e,
                data: t
              }
    ...
    Ha = {
      source: vt({
        id: Xe("src_"),
        client_secret: Xe("src_client_secret_")
      })
    },
    za = vt(Ha),
    Ya = function(e) {
    ...
    Ga = function(e) {
      return Et(Ia(null), e, "createPaymentMethod").value
    },
    Wa = function(e, t, n, r, o) {
      var i = ha(r),
        ...
        u = c.type,
        s = c.data;
      if (u && n !== u) return Ne.reject(new Pe("The type supplied in payment_method_data is not consistent."));
      if (i) {
        var l = i._frame.id,
          p = i._componentName;
      ...
      return a ? e.action.createPaymentMethodWithData({
        ...
        paymentMethodData: s,
        mids: t
      }).then(Ya) : Ne.reject(new Pe("Please provide either an Element or PaymentMethod creation parameters to createPaymentMethod."))
    },
    Ka = function(e, t, n, r, o) {
      if ("string" == typeof n) return Wa(e, t, n, r, o);
      try {
        var i = Ga(n),
          a = i.element,
          c = i.type,
    ...
    Ja = function(e, t) {
      return Et(Aa, e, "stripe." + t + " intent secret").value
    },
    Qa = function(e, t) {
      return Et(Ra, t, e).value
    },
    $a = function(e, t, n) {
      if ("valid" === gt(fa, n, t).type) throw new Pe("Do not pass an Element to stripe." + t + "() directly.\nFor more information: " + Va(t));
      var r = Et(Na(e, t), n, t),
        o = r.value,
        i = o.source,
        ...
        c = o.paymentMethod,
        u = o.otherParams;
      if (null != i && (null != a || null != c)) throw new Pe(t + ": Expected either source or payment_method, but not both.");
      return a ? a.element ? {
        confirmMode: {
    ...
    ec = function(e, t, n) {
      ...
      if ("use_stripe_sdk" === e.type) {
        ...
        switch (r.type) {
          case "stripe_3ds2_fingerprint":
            return {
              type: "3ds2-fingerprint", threeDS2Source: r.three_d_secure_2_source, cardBrand: Xa(r.directory_server_name), transactionId: r.server_transaction_id, optimizations: Za(r.three_ds_optimizations, n), methodUrl: r.three_ds_method_url
            };
          case "stripe_3ds2_challenge":
            return {
              type: "3ds2-challenge", threeDS2Source: r.stripe_js.three_d_secure_2_source, cardBrand: Xa(r.stripe_js.directory_server_name), transactionId: r.stripe_js.server_transaction_id, optimizations: Za(r.stripe_js.three_ds_optimizations, n), acsTransactionId: r.stripe_js.acs_transaction_id, acsUrl: r.stripe_js.acs_url
            };
      ...
      if ("redirect_to_url" === e.type) {
        ...
        switch (t) {
          ...
          case _a.fpx:
            return {
              type: "fpx-redirect", redirectUrl: o
            }
        }
      }
      if ("authorize_with_url" === e.type) {
        ...
        switch (t) {
          case _a.card:
            return {
              type: "3ds1-modal", url: i, source: null
            };
          case _a.ideal:
            return {
    ...
    nc = function(e, t, n, r) {
      ...
      }).then(tc) : n.action.retrieveSetupIntent({
        hosted: !1,
        intentSecret: e,
        locale: r,
        asErrorIfNotSucceeded: !0
    ...
    rc = function(e, t, n, r, o) {
      return t === Lt.PAYMENT_INTENT ? n.action.cancelPaymentIntentSource({
        ...
        locale: o,
        sourceId: r
      }).then(tc) : n.action.cancelSetupIntentSource({
        intentSecret: e,
        locale: o,
        sourceId: r
      }).then(tc)
    ...
    ac = function(e, t, n, r, o) {
      return e.createLightboxFrame(At.AUTHORIZE_WITH_URL, ic({
        url: t,
        locale: o,
        intentId: n
      }, r ? {
    ...
    cc = function(e, t, n, r, o) {
      var i = xr(),
        a = Date.now(),
        c = ac(r, e.url, t.id, e.source, o);
      c.show(), r.report("authorize_with_url.loading", {
        viewport: i,
        intentId: t.id
      }), c._on("load", function() {
      ...
      return c._on("challenge_complete", function() {
        c.fadeOutBackdrop()
      }), new Ne(function(i, s) {
        var l = e.source;
        l && c._once("cancel", function() {
          c.fadeOutBackdrop(), rc(t, n, r, l, o).then(i)
          ...
          var s = function() {
            return Ne.all([nc(t, n, r, o), c.destroy()]).then(function(e) {
              return oc(e, 1)[0]
            })
          };
          "fallback" === e.type ? s().then(i) : e.result.error && !u(e.result.error) ? s().then(i) : c.destroy().then(function() {
            return i(e.result)
          })
        })
      })
    ...
    hc = function(e, t, n, r, o, i) {
      var a = Date.now(),
        ...
        l = function(n) {
          return Ne.all([n ? Ne.resolve(n) : nc(e, t, r, o), c.then(function(e) {
            return e.destroy()
          })]).then(function(t) {
            var n = uc(t, 1),
              o = n[0];
            return r.report("3ds2.done", sc({
              intentId: e.id,
              hosted: i,
      ...
      switch (n.type) {
        ...
        case "3ds2-fingerprint":
          return fc(e, n, r, i, o).then(s).then(function(t) {
    ...
    yc = function(e, t, n) {
      return _c(t).then(function(t) {
        return mc(n, "ideal redirect", t), ga(t, e)
      })
    },
    vc = function(e, t, n) {
      return _c(t).then(function(t) {
        return mc(n, "fpx redirect", t), ga(t, e)
      })
    },
    bc = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
      return typeof e
    } : function(e) {
      return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
    },
    gc = function(e) {
      switch (e.type) {
        case "error":
          var t = e.error;
          if ("payment_intent_unexpected_state" === t.code && "object" === bc(t.payment_intent) && null != t.payment_intent && "string" == typeof t.payment_intent.status && ka(t.payment_intent.status)) {
    ...
    Ec = function(e, t, n, r, o) {
      var i = ec(Oa(t), n, e),
        a = Sa(t);
      if (!i) return Ne.resolve({
        paymentIntent: t
      });
      switch (i.type) {
        case "3ds1-modal":
          return cc(i, a, Lt.PAYMENT_INTENT, e, r);
        case "3ds2-fingerprint":
        case "3ds2-challenge":
          return hc(a, Lt.PAYMENT_INTENT, i, e, r, o);
        case "ideal-redirect":
          return yc(t, i.redirectUrl, e);
        case "fpx-redirect":
          return vc(t, i.redirectUrl, e);
        default:
          return Ne.resolve({
            paymentIntent: t
          })
    ...
    Oc = function(e, t) {
      return function(n, r, o, i, a) {
        var c = Ja(o, e),
          u = $a(t, e, i),
          s = Qa(e, a),
          l = "none" === u.confirmMode.tag,
          p = n.action.confirmPaymentIntent(kc({}, u, {
            intentSecret: c,
            expectedType: t,
            options: s,
            mids: r
          }));
        return s.handleActions ? p.then(Sc(n, t, l, !1)) : p.then(ga)
      }
    },
    Pc = Oc("confirmCardPayment", _a.card),
    Ac = Oc("confirmSepaDebitPayment", _a.sepa_debit),
    Tc = Oc("confirmAuBecsDebitPayment", _a.au_becs_debit),
    Ic = Oc("confirmBacsDebitPayment", _a.bacs_debit),
    Rc = Oc("confirmIdealPayment", _a.ideal),
    Nc = Oc("confirmFpxPayment", _a.fpx),
    Cc = function(e, t) {
      var n = Ja(e, "retrievePaymentIntent");
    ...
    Mc = function(e, t) {
      var n = Ja(e, "handleHosted3DS2Setup [internal]");
      return t.action.retrievePaymentIntent({
        intentSecret: n,
        hosted: !0
      }).then(Sc(t, _a.card, !1, !0))
    },
    jc = function(e, t) {
      var n = Ja(e, "handleCardAction");
      return t.action.retrievePaymentIntent({
        intentSecret: n,
        hosted: !1
      }).then(function(e) {
        ...
        switch (n.type) {
          case "error":
            return Ne.resolve(ga(e));
          case "object":
            var r = n.object;
            if (ka(r.status)) {
              if ("manual" !== r.confirmation_method) throw new Pe("handleCardAction: The PaymentIntent supplied does not require manual server-side confirmation. Please use confirmCardPayment instead to complete the payment.");
              return wc(t, r, _a.card, n.locale, !1)
            }
            throw new Pe("handleCardAction: The PaymentIntent supplied is not in the requires_action state.");
          default:
            return Ae(n)
        }
      })
    ...
    xc = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
      return typeof e
    } : function(e) {
      return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
    },
    ...
    Dc = function(e, t, n, r) {
      if (null === e) {
        if (null === t) {
          throw new Pe(n + ": you must additionally specify the type of payment method to create within " + (r ? "source_data" : "payment_method_data") + ".")
        }
        return t
      }
      if (null === t) return e;
      if (t !== e) throw new Pe(n + ": you specified `type: " + t + "`, but " + n + " will create a " + e + " payment method.");
      return e
    },
    Fc = function(e) {
      return function(t, n) {
        if ("object" === (void 0 === t ? "undefined" : xc(t)) && null !== t) {
          var r = t.source,
            o = t.source_data,
            i = t.payment_method,
            a = t.payment_method_data,
            c = pe(t, ["source", "source_data", "payment_method", "payment_method_data"]);
          if (null != r && "string" != typeof r) return Ve("string", void 0 === r ? "undefined" : xc(r), bt(n, "source"));
          if (null != i && "string" != typeof i) return Ve("string", void 0 === i ? "undefined" : xc(i), bt(n, "payment_method"));
          if (null != o && "object" !== (void 0 === o ? "undefined" : xc(o))) return Ve("object", void 0 === o ? "undefined" : xc(o), bt(n, "source_data"));
          if (null != a && "object" !== (void 0 === a ? "undefined" : xc(a))) return Ve("object", void 0 === a ? "undefined" : xc(a), bt(n, "payment_method_data"));
          var u = qc(o, bt(n, "source_data"));
          if ("error" === u.type) return u;
          var s = u.value,
            l = qc(a, bt(n, "payment_method_data"));
        ...
        return null === t ? Ve("object", "null", n) : Ve("object", void 0 === t ? "undefined" : xc(t), n)
      }
    },
    Bc = function(e) {
      return function(t, n) {
        if (void 0 === t) return We({
          sourceData: null,
          paymentMethodData: null,
          source: null,
          paymentMethod: null,
        ...
        if ("object" !== (void 0 === t ? "undefined" : xc(t))) return Ve("object", void 0 === t ? "undefined" : xc(t), n);
        if (null === t) return Ve("object", "null", n);
        if (e) {
          if (!t.payment_intent) return We({
            sourceData: null,
            paymentMethodData: null,
            source: null,
            paymentMethod: null,
          ...
          return Fc(o)(r, bt(n, "payment_intent"))
        }
        return t.payment_intent ? Ke(new Pe("The payment_intent parameter has been removed. To fix, move everything nested under the payment_intent parameter to the top-level object.")) : Fc({})(t, n)
      }
    },
    Uc = function(e, t, n, r, o, i) {
      ...
      var c = a.value,
        ...
        l = s.sourceData,
        p = s.source,
        d = s.paymentMethodData,
        f = s.paymentMethod,
        h = s.otherParams;
      if (!e && l) throw new Pe(r + ": Expected payment_method_data, not source_data.");
      if (null != p) throw new Pe("When calling " + r + " on an Element, you can't pass in a pre-existing source ID, as a source will be created using the Element.");
      if (null != f) throw new Pe("When calling " + r + " on an Element, you can't pass in a pre-existing PaymentMethod ID, as a PaymentMethod will be created using the Element.");
    ...
    Hc = function(e, t, n, r, o, i) {
      var a = Et(Bc(t), o, r),
        ...
        p = c.paymentMethod,
        d = c.otherParams;
      if (!e && u) throw new Pe(r + ": Expected payment_method, source, or payment_method_data, not source_data.");
      if (null !== s && null !== u) throw new Pe(r + ": Expected either source or source_data, but not both.");
      if (null !== p && null !== l) throw new Pe(r + ": Expected either payment_method or payment_method_data, but not both.");
      if (null !== p && null !== s) throw new Pe(r + ": Expected either payment_method or source, but not both.");
      if (u || l) {
        var f = u || l || {},
          h = f.type,
          _ = f.data,
    ...
    zc = function(e, t, n, r) {
      return function(o, i) {
        var a = Uc(e, t, n, r, o, i);
        if (a) return a;
        var c = Hc(e, t, n, r, o);
        if (c) return c;
        throw new Pe("Expected: stripe." + r + "(intentSecret, element[, data]) or stripe." + r + "(intentSecret[, data]). Please see the docs for more usage examples https://stripe.com/docs/payments/dynamic-authentication")
      }
    },
    ...
    Gc = function(e, t, n, r, o, i) {
      var a = Et(Aa, r, "stripe.confirmPaymentIntent intent secret"),
        c = a.value,
        u = zc(e, !1, null, "confirmPaymentIntent")(o, i);
      return t.action.confirmPaymentIntent(Yc({}, u, {
        intentSecret: c,
        expectedType: null,
        options: {
          handleActions: !1
    ...
    Wc = function(e, t, n, r, o, i, a) {
      var c = Et(Aa, o, "stripe.handleCardPayment intent secret"),
        u = c.value,
        s = _a.card,
        l = zc(e, r, s, "handleCardPayment")(i, a),
        p = !i && !a;
      return t.action.confirmPaymentIntent(Yc({}, l, {
        intentSecret: u,
        expectedType: s,
        options: {
          handleActions: !0
    ...
    Kc = function(e, t, n, r, o, i) {
      var a = Et(Aa, r, "stripe.handleSepaDebitPayment intent secret"),
        c = a.value,
        u = _a.sepa_debit,
        s = zc(!1, n, u, "handleSepaDebitPayment")(o, i),
        l = !o && !i;
      return e.action.confirmPaymentIntent(Yc({}, s, {
        intentSecret: c,
        expectedType: u,
        options: {
          handleActions: !0
    ...
    Vc = function(e, t, n, r, o, i, a) {
      var c = Et(Aa, o, "stripe.handleIdealPayment intent secret"),
        u = c.value,
        s = _a.ideal,
        l = zc(e, r, s, "handleIdealPayment")(i, a),
        p = !i && !a;
      return t.action.confirmPaymentIntent(Yc({}, l, {
        intentSecret: u,
        expectedType: s,
    ...
    Jc = function(e, t, n, r, o, i) {
      var a = Et(Aa, r, "stripe.handleFpxPayment intent secret"),
        c = a.value,
        u = _a.fpx,
        s = zc(!1, n, u, "handleFpxPayment")(o, i),
        l = !o && !i;
      return e.action.confirmPaymentIntent(Yc({}, s, {
        intentSecret: c,
        expectedType: u,
    ...
    Qc = function(e, t, n, r, o) {
      ...
      switch (i.type) {
        case "3ds1-modal":
          return cc(i, a, Lt.SETUP_INTENT, e, r);
        case "3ds2-fingerprint":
        case "3ds2-challenge":
          return hc(a, Lt.SETUP_INTENT, i, e, r, o);
        default:
          return Ne.resolve({
            setupIntent: t
          })
    ...
    $c = function(e, t, n, r, o) {
      return Qc(e, t, n, r, o).then(function(e) {
    ...
    Zc = function(e, t, n, r) {
      return function(o) {
        switch (o.type) {
          ...
          case "object":
            var c = o.object;
            return $c(e, c, t, o.locale, r);
          default:
            return Ae(o)
        }
      }
    },
    Xc = Object.assign || function(e) {
      for (var t = 1; t < arguments.length; t++) {
        var n = arguments[t];
        for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r])
      }
    ...
    eu = function(e, t) {
      return function(n, r, o, i, a) {
        var c = Ja(o, e),
          ...
          s = Qa(e, a),
          l = "none" === u.confirmMode.tag,
          p = n.action.confirmSetupIntent(Xc({}, u, {
            intentSecret: c,
            expectedType: t,
            options: s,
            mids: r
          }));
        return s.handleActions ? p.then(Zc(n, t, l, !1)) : p.then(Ea)
      }
    },
    tu = eu("confirmCardSetup", _a.card),
    nu = eu("confirmSepaDebitSetup", _a.sepa_debit),
    ru = eu("confirmAuBecsDebitSetup", _a.au_becs_debit),
    ou = eu("confirmBacsDebitSetup", _a.bacs_debit),
    iu = function(e, t) {
      var n = Ja(e, "retrieveSetupIntent");
    ...
    uu = function(e, t, n, r, o) {
      var i = Et(Aa, n, "stripe.handleCardSetup intent secret"),
        a = i.value,
        c = _a.card,
        u = zc(!1, !1, c, "handleCardSetup")(r, o),
        s = !r && !o;
      return e.action.confirmSetupIntent(cu({}, u, {
        intentSecret: a,
        expectedType: c,
        options: {
          handleActions: !0
    ...
    su = function(e, t, n, r, o) {
      var i = Et(Aa, n, "stripe.handleSepaDebitSetup intent secret"),
        a = i.value,
        c = _a.sepa_debit,
        u = zc(!1, !1, c, "handleSepaDebitSetup")(r, o),
        s = !r && !o;
      return e.action.confirmSetupIntent(cu({}, u, {
        intentSecret: a,
        expectedType: c,
    ...
    lu = function(e, t, n, r, o) {
      var i = Et(Aa, n, "stripe.confirmSetupIntent intent secret"),
        a = i.value,
        c = zc(!1, !1, null, "confirmSetupIntent")(r, o);
      return e.action.confirmSetupIntent(cu({}, c, {
        otherParams: cu({}, c.otherParams),
        intentSecret: a,
        expectedType: null,
        options: {
          handleActions: !1
    ...
    pu = [Dr.checkout_beta_2, Dr.checkout_beta_3, Dr.checkout_beta_4],
    du = [Dr.checkout_beta_2, Dr.checkout_beta_3, Dr.checkout_beta_4, Dr.checkout_pm_types, Dr.checkout_beta_locales],
    fu = {
      da: "da",
      de: "de",
      en: "en",
    ...
    vu = {
      ...
      locale: Qe(et.apply(void 0, ["auto"].concat(fe(_u)))),
      customerEmail: Qe(ot),
      billingAddressCollection: Qe(et("required", "auto")),
      submitType: Qe(et("auto", "pay", "book", "donate")),
      paymentMethodTypes: Qe(ft(et("card", "ideal"))),
      allowIncompleteSubscriptions: Qe(at)
    },
    bu = function(e, t, n) {
      if (e && t || (e || t) && n) throw new Pe("stripe.redirectToCheckout: Expected only one of sku, plan, or items.");
      ...
      throw new Pe("stripe.redirectToCheckout: You must provide either sku, plan, or items.")
    },
    gu = function(e) {
      var t = yt(yu({}, vu, {
          items: Qe($e(ft(yt({
    ...
    Eu = function(e, t, n) {
      var r = yt(yu({}, vu, {
          ...
          locale: Qe(et.apply(void 0, ["auto"].concat(fe(_u), fe(mu))))
        } : {})),
        o = Et(r, t, "stripe.redirectToCheckout"),
        i = o.value;
      if (i.sessionId) {
        var a = i.sessionId;
        if (Object.keys(i).length > 1) throw new Pe("stripe.redirectToCheckout: Do not provide other parameters when providing sessionId. Specify all parameters on your server when creating the CheckoutSession.");
        if (!/^cs_/.test(a)) throw new Pe("stripe.redirectToCheckout: Invalid value for sessionId. You specified '" + a + "'.");
        if ("livemode" === n && /^cs_test_/.test(a)) throw new Pe("stripe.redirectToCheckout: the provided sessionId is for a test mode Checkout Session, whereas Stripe.js was initialized with a live mode publishable key.");
        if ("testmode" === n && /^cs_live_/.test(a)) throw new Pe("stripe.redirectToCheckout: the provided sessionId is for a live mode Checkout Session, whereas Stripe.js was initialized with a test mode publishable key.");
        return {
          tag: "session",
          sessionId: a
        }
      ...
      var c = (i.sessionId, i.sku, i.plan, i.items),
        u = i.successUrl,
        s = i.cancelUrl,
        l = de(i, ["sessionId", "sku", "plan", "items", "successUrl", "cancelUrl"]);
      if (!c) throw new Pe("stripe.redirectToCheckout: You must provide one of items or sessionId.");
      if (!u || !s) throw new Pe("stripe.redirectToCheckout: You must provide successUrl and cancelUrl.");
      return yu({
        tag: "no-session",
        items: c,
        successUrl: u,
    ...
    wu = function(e, t, n) {
      ...
      if ("no-session" === r.tag) {
        var o = r.successUrl,
          i = r.cancelUrl;
        if (!St(o)) throw new Pe("stripe.redirectToCheckout: successUrl must start with either http:// or https://.");
        if (!St(i)) throw new Pe("stripe.redirectToCheckout: cancelUrl must start with either http:// or https://.");
        return r
      }
      return r
    },
    Su = function(e, t, n) {
      if (n && n.paymentMethodTypes) {
        if (-1 === t.indexOf("checkout_pm_types")) throw new Pe("Invalid stripe.redirectToCheckout parameter: paymentMethodTypes is not an accepted parameter.");
        if (e) throw new Pe("Invalid stripe.redirectToCheckout parameter: paymentMethodTypes is not an accepted parameter for " + e + ". Please follow our migration guide to update to the final version of Checkout: https://stripe.com/docs/payments/checkout/migration-from-beta")
      }
    },
    ku = function(e, t) {
      return "session" === t.tag || null == e || t.locale || -1 === ["auto"].concat(fe(_u)).indexOf(e) ? t : yu({}, t, {
        locale: e
      })
    },
    Ou = function(e, t, n) {
      var r = Ce(pu, function(t) {
        return Br(e, t)
      });
      switch (Su(r, e, t), r) {
    ...
    Pu = function(e, t, n) {
      ...
      return ku(t, Ou(e, n, r))
    },
    Au = Pu,
    Tu = Object.assign || function(e) {
      for (var t = 1; t < arguments.length; t++) {
        var n = arguments[t];
        for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r])
      }
    ...
    Iu = function(e, t) {
      var n = function(t) {
        return mc(e, "redirectToCheckout", t), {
          error: t.error
        }
      };
      return _c(t).then(n)
    ...
    Ru = function(e, t, n, r) {
      return function(o) {
        ...
        var u = i,
          ...
          l = u.successUrl,
          p = u.cancelUrl,
          d = u.clientReferenceId,
          f = u.customerEmail,
          h = u.billingAddressCollection,
          _ = u.submitType,
          m = u.paymentMethodTypes,
          y = u.allowIncompleteSubscriptions,
          v = he(u, ["tag", "items", "successUrl", "cancelUrl", "clientReferenceId", "customerEmail", "billingAddressCollection", "submitType", "paymentMethodTypes", "allowIncompleteSubscriptions"]),
          b = s.map(function(e) {
            if (e.sku) return {
              type: "sku",
              id: e.sku,
        ...
        return e.action.createPaymentPage(Tu({
          betas: t,
          mids: n(),
          items: b,
          success_url: l,
    ...
    Nu = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
      return typeof e
    } : function(e) {
      return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
    },
    ...
    Mu = function(e) {
      return "object" === (void 0 === e ? "undefined" : Nu(e)) && null !== e ? e : {}
    },
    ju = function(e, t, n) {
      var r = ha(t);
      ...
      throw new Pe("You must provide a `cardCvc` Element to create a `cvc_update` token.")
    },
    Lu = function(e, t) {
      return function(n, r) {
        var o = ha(n);
        ...
        throw new Pe("You must provide a Stripe Element or a valid token type to create a Token.")
      }
    },
    xu = function(e) {
      switch (e.type) {
    ...
    Bu = vt({
      ...
      betas: Qe(ft(tt.apply(void 0, me(Fr))))
    }),
    Uu = function(e) {
    ...
    Hu = function(e) {
      return function() {
        throw new Pe("You cannot call `stripe." + e + "` without supplying a PaymentIntents beta flag when initializing Stripe.js.    You can find more information including code snippets at https://www.stripe.com/docs/payments/payment-intents/quickstart.")
      }
    },
    zu = function() {
      function e(t, n) {
        var r = this;
        _e(this, e), Yu.call(this);
        var o = Et(Bu, t || {}, "Stripe()"),
          i = o.value,
          a = o.warnings,
          c = i.apiKey,
          u = i.stripeAccount,
          ...
          h = i.betas;
        if ("" === c) throw new Pe("Please call Stripe() with your publishable key. You used an empty string.");
        if (0 === c.indexOf("sk_")) throw new Pe("You should not use your secret key with Stripe.js.\n        Please pass a publishable key instead.");
        p && p.mids && (e._ec = new Da({
          checkoutIds: p.mids
        })), this._apiKey = c, this._keyMode = Ue(c), this._locale = s || null, this._betas = h || [], this._stripeAccount = u || null, this._isCheckout = !!p, this._controller = new Lr(Du({
          apiKey: c,
          __privateApiUrl: l,
          stripeAccount: u,
          betas: this._betas,
        ...
        }), this._ensureHTTPS(), this._ensureStripeHosted(n), this._attachPaymentIntentMethods(this._betas, !!d), this._attachLegacyPaymentIntentMethods(this._betas), this._attachCheckoutMethods(this._betas), this._attachPrivateMethodsForCheckout(this._isCheckout), this._attachCreateRadarSession(f || !1)
      }
      return Fu(e, [{
        ...
        value: function(e, t) {
          ...
          this.createPaymentMethod = ln(function() {
            ...
            return Ka.apply(void 0, [n._controller, r()].concat(t))
          }), this.retrievePaymentIntent = un(function(e) {
            return Cc(e, n._controller)
          }), this.retrieveSetupIntent = un(function(e) {
            return iu(e, n._controller)
          });
          var o = Nn(jc, Uu("handleCardAction"));
          this.handleCardAction = un(function(e) {
            return o(e, n._controller)
          });
          var i = Nn(Pc, Uu("confirmCardPayment"));
          this.confirmCardPayment = ln(function() {
            for (var e = arguments.length, t = Array(e), o = 0; o < e; o++) t[o] = arguments[o];
            return i.apply(void 0, [n._controller, r()].concat(t))
          });
          var a = Nn(tu, Uu("confirmCardSetup"));
          ...
          }), this.confirmFpxPayment = Hu("confirmFpxPayment"), Br(this._betas, Dr.fpx_bank_beta_1) && (this.confirmFpxPayment = ln(function() {
            for (var e = arguments.length, t = Array(e), o = 0; o < e; o++) t[o] = arguments[o];
            return Nc.apply(void 0, [n._controller, r()].concat(t))
          })), Br(this._betas, Dr.au_bank_account_beta_2) && (this.confirmAuBecsDebitPayment = ln(function() {
            for (var e = arguments.length, t = Array(e), o = 0; o < e; o++) t[o] = arguments[o];
          ...
          })), Br(this._betas, Dr.bacs_debit_beta) && (this.confirmBacsDebitPayment = ln(function() {
            for (var e = arguments.length, t = Array(e), o = 0; o < e; o++) t[o] = arguments[o];
          ...
          })), t && (this.handleHosted3DS2Payment = un(function(e) {
            return Mc(e, n._controller)
          }), this.handleHosted3DS2Setup = un(function(e) {
            return au(e, n._controller)
          }))
        }
      }, {
        ...
        value: function(e) {
          var t = this,
            n = Br(this._betas, Dr.payment_intent_beta_1) || Br(this._betas, Dr.payment_intent_beta_2),
            r = function() {
              return t._mids()
            },
            o = ln(function() {
              for (var e = arguments.length, n = Array(e), o = 0; o < e; o++) n[o] = arguments[o];
              return Gc.apply(void 0, [!0, t._controller, r()].concat(n))
            }),
            i = ln(function() {
              for (var e = arguments.length, n = Array(e), o = 0; o < e; o++) n[o] = arguments[o];
              return Gc.apply(void 0, [!1, t._controller, r()].concat(n))
            }),
            a = Nn(Wc, Uu("handleCardPayment")),
            c = ln(function() {
            ...
            p = ln(function() {
              for (var e = arguments.length, n = Array(e), o = 0; o < e; o++) n[o] = arguments[o];
              return lu.apply(void 0, [t._controller, r()].concat(n))
            }),
            d = ln(function() {
              for (var e = arguments.length, o = Array(e), i = 0; i < e; i++) o[i] = arguments[i];
              return Kc.apply(void 0, [t._controller, r(), n].concat(o))
            }),
            f = ln(function() {
              for (var e = arguments.length, n = Array(e), o = 0; o < e; o++) n[o] = arguments[o];
            ...
            h = ln(function() {
              for (var e = arguments.length, o = Array(e), i = 0; i < e; i++) o[i] = arguments[i];
              return Vc.apply(void 0, [!0, t._controller, r(), n].concat(o))
            }),
            _ = ln(function() {
              for (var e = arguments.length, o = Array(e), i = 0; i < e; i++) o[i] = arguments[i];
              return Vc.apply(void 0, [!1, t._controller, r(), n].concat(o))
            }),
            m = ln(function() {
              for (var e = arguments.length, o = Array(e), i = 0; i < e; i++) o[i] = arguments[i];
              return Jc.apply(void 0, [t._controller, r(), n].concat(o))
            });
          this.handleCardPayment = u, this.confirmPaymentIntent = i, this.handleCardSetup = l, this.confirmSetupIntent = p, this.fulfillPaymentIntent = Hu("fulfillPaymentIntent"), this.handleSepaDebitPayment = Hu("handleSepaDebitPayment"), this.handleSepaDebitSetup = Hu("handleSepaDebitSetup"), this.handleIdealPayment = Hu("handleIdealPayment"), this.handleFpxPayment = Hu("handleFpxPayment"), Br(this._betas, Dr.payment_intent_beta_1) ? this.fulfillPaymentIntent = c : (Br(this._betas, Dr.payment_intent_beta_3) || Br(this._betas, Dr.payment_intent_beta_2)) && (this.handleCardPayment = c), Br(this._betas, Dr.payment_intent_beta_3) && (this.confirmPaymentIntent = o, this.handleIdealPayment = h, this.handleSepaDebitPayment = d), Br(this._betas, Dr.fpx_bank_beta_1) && (this.handleFpxPayment = m), Br(this._betas, Dr.ideal_pm_beta_1) && (this.handleIdealPayment = _), Br(this._betas, Dr.sepa_pm_beta_1) && (this.handleSepaDebitPayment = d, this.handleSepaDebitSetup = f)
        }
      }, {
        key: "_attachPrivateMethodsForCheckout",
        value: function(e) {
          var t = this;
          e && (this.tryNextAction = sn(function(e, n) {
            var r = Et(Ta, e, "Payment Intent"),
              o = r.value,
              ...
              c = a.value;
            return "payment_intent" === o.object ? wc(t._controller, o, c, "auto", !1) : $c(t._controller, o, c, "auto", !1)
          }))
        }
      }, {
        ...
        value: function(e) {
          var t = this,
            ...
            r = e.reduce(function(e, t) {
              var n = Ce(du, function(e) {
                return e === t
              });
              return n ? [].concat(me(e), [n]) : e
            }, []);
          this.redirectToCheckout = Ru(this._controller, r, n, this._locale)
        }
      }, {
        key: "_ensureHTTPS",
        value: function() {
        ...
        value: function(e) {
          if (!e) throw this._controller.report("user_error.self_hosted"), new Pe("Stripe.js must be loaded from js.stripe.com. For more information https://stripe.com/docs/stripe-js/reference#including-stripejs")
        }
      }, {
        key: "_mids",
        value: function() {
  ...
  zu.version = 3, zu.stripeJsId = Gt(), zu._ec = function() {
    return "https://checkout.stripe.com/".match(new RegExp(document.location.protocol + "//" + document.location.host)) ? null : new Da
  }();
  var Yu = function() {
      var e = this;
      this.elements = un(function(t) {
        return new sa(e._controller, Du({}, e._locale ? {
          locale: e._locale
        } : {}, t, {
          betas: e._betas
        }))
        ...
        var r = e._mids();
        if ("cvc_update" === t) {
          if (Br(e._betas, Dr.cvc_update_beta_1)) return ju(e._controller, n, r);
          throw new Pe("You cannot create a 'cvc_update' token without using the 'cvc_update_beta_1' beta flag.")
        }
        return Lu(e._controller, r)(t, n)
        ...
        if (r) {
          var u = r._frame.id,
            s = r._componentName;
          return !o && ya(s) ? Ne.reject(new Pe("Please provide Source creation parameters to createSource.")) : e._controller.action.createSourceWithElement({
            frameId: u,
            elementName: s,
            type: a,
            sourceData: c,
        ...
        return o ? a ? e._controller.action.createSourceWithData({
          ...
          sourceData: c,
          mids: e._mids()
        }).then(Ua) : Ne.reject(new Pe("Please provide a source type to createSource.")) : Ne.reject(new Pe("Please provide either an Element or Source creation parameters to createSource."))
      }), this.retrieveSource = un(function(t) {
        var n = Et(za, {
            source: t
          }, "retrieveSource"),
          r = n.value;
        return n.warnings.forEach(function(t) {
          return e._controller.warn(t)
        }), e._controller.action.retrieveSource(r).then(Ua)
      }), this.paymentRequest = sn(function(t, n) {
        He(e._keyMode);
        var r = e._isCheckout && n ? n : null;
        return pa(e._controller, {
          apiKey: e._apiKey,
    ...
    Ju = function(e, t) {
      return new Gu(Ku({
        apiKey: e
      }, t && "object" === (void 0 === t ? "undefined" : Wu(t)) ? t : {}), Vu)
    };
  Ju.version = Gu.version, window.Stripe && 2 === window.Stripe.version && !window.Stripe.StripeV3 ? window.Stripe.StripeV3 = Ju : window.Stripe ? window.console && console.warn("It looks like Stripe.js was loaded more than one time. Please only load it once per page.") : window.Stripe = Ju;
  t.default = Ju
}, function(e, t, n) {
  "use strict";
